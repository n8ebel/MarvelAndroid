...
public class SeriesSummaryDeserializer implements JsonDeserializer<SeriesSummary> {
    private static final String TAG = SeriesSummaryDeserializer.class.getSimpleName();

    public SeriesSummary deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
