...
public class ComicSummaryDeserializer implements JsonDeserializer<ComicSummary> {
    private static final String TAG = ComicSummaryDeserializer.class.getSimpleName();
